...
let EventsDB = [
    {
        id: uuid(),
        title: 'Codeworks',
        text: 'Вистинскиот настан за сите tech таленти кои сакаат да кодираат и да научат што е ново во tech заедницата. Настан кој ги поврзува mid програмерите со IT компаниите. \n Deep Dive Intensive Seminar \n Ексклузивни семинари кои комбинираат три различни техники на учење.',
        image: 'codeworks',
    ...
    },
    {
        ...
        calendarDetails: [
            {
                title: 'Deep Dive into Marketing',
                start: new Date('June 10, 2020 19:30:00'),
                end: new Date('June 10, 2020 21:00:00'),
                additionalInfo: 'Ден 1',
                color: 'red'
            },
            {
                title: 'Deep Dive into Marketing',
                start: new Date('June 26, 2020 19:00:00'),
                end: new Date('June 26, 2020 22:00:00'),
    ...
    },
    {
        ...
        calendarDetails: [
            {
                title: 'Deep Dive into Data Science',
                start: new Date('May 5, 2020 10:00:00'),
                end: new Date('May 5, 2020 18:00:00'),
                additionalInfo: 'Ден 1',
                color: 'blue'
            },
            {
                title: 'Deep Dive into Data Science',
                start: new Date('May 31, 2020 10:00:00'),
                end: new Date('May 31, 2020 18:00:00'),
                additionalInfo: 'Ден 2',
                color: 'blue'
            }
        ]
