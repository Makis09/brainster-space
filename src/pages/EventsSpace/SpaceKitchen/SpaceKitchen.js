      ...
      <Col lg={4} md={12} sm={12} className="imageGallery">
        <Row>
          <Col lg={12} md={6} sm={6}>
            <Image
              fluid
              src={require("../../../assets/images/space kitchen/IMG_7777.jpg")}
            />
          </Col>
          <Col md={6} sm={6} className="bigImageSMscreen">
            <Image
              fluid
              src={require("../../../assets/images/space kitchen/IMG_7362.jpg")}
            />
          </Col>
        </Row>
        <Row>
          <Col lg={6} md={6} sm={6}>
            <Image
              ...
              fluid
              src={require("../../../assets/images/space kitchen/IMG_7385.jpg")}
            />
          </Col>
          <Col lg={6} md={6} sm={6}>
            <Image
              className="smallImage"
              fluid
              src={require("../../../assets/images/space kitchen/IMG_7361.jpg")}
            />
          </Col>
        </Row>
      </Col>
